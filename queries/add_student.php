...
if(isset($_POST["do"])&&($_POST["do"]=="add_student")){
    ...
    if($index_number == $index_number1){
        ...
        if(move_uploaded_file($tmpname, $image_path)){
            $sql="INSERT INTO student(index_number,name,address,gender,phone,email,image,reg_date,reg_year,reg_month)
                VALUES('".$index_number."','".$name."','".$address."','".$gender."','".$phone."','".$email."','".$image_path."','".$current_date."','".$current_year."','".$current_month."')";
    ...
    header("Location: student.php?do=alert_from_insert&msg=$msg&student_id=$student_id");
