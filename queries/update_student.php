...
if(isset($_POST["do"])&&($_POST["do"]=="update_student")){
    ...
    $sql6="SELECT * FROM student_grade WHERE student_id='$id'";
    $result6=mysqli_query($conn,$sql6);
    $row6=mysqli_fetch_assoc($result6);
    $grade_id=$row6['grade_id'];
    ...
    if($id == $id1){
        ...
        if($id == $id2){
            ...
            if(!$image_name){
                ...
                $sql = "UPDATE student SET index_number='".$index_number."',name='".$name."',address='".$address."',gender='".$gender."',phone='".$phone."',email='".$email."' WHERE id='$id' ";
                ...
                if(move_uploaded_file($tmpname, $image_path)){
                    ...
                    $sql = "UPDATE student SET index_number='" . $index_number . "',name='" . $name . "',address='" . $address . "',gender='" . $gender . "',phone='" . $phone . "',email='" . $email . "',image='" . $image_path . "' WHERE id='$id' ";
    ...
    if(isset($_POST["user"])&&($_POST["user"]=="Admin")){
        ...
        header("Location: all_student.php?do=alert_from_update&msg=$msg&grade_id=$grade_id");

    }

    if(isset($_POST["user"])&&($_POST["user"]=="Teacher")){

        header("Location: my_student.php?do=alert_from_update&msg=$msg&grade_id=$grade_id");
        
    }

    if(isset($_POST["user"])&&($_POST["user"]=="Student")){

        header("Location: student_profile.php?do=alert_from_update&msg=$msg");
