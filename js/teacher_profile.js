function editMyProfile(recordID){
	...
	xhttp.onreadystatechange = function() {		
		...
		if (this.readyState == 4 && this.status == 200) {
            ...
            xhttp1.open("GET", "./queries/get_teacher.php?id=" + id , true);												
            xhttp1.send();
    ...
    xhttp.open("GET", "my_profile_update_form_teacher.php" , true);												
    xhttp.send();
...
function updatePassword(){
    ...
    if (current_password !== '' && new_password !== '' && confirm_password !== '') {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (msg == 1 ) {
                    ...
                    setTimeout(function(){
                        ...
                        $(location).attr('href', 'http://localhost/std/login.php');  
        ...
        xhttp.open("GET", "./queries/update_password.php?username=" + username + "&current_password=" + current_password + "&new_password=" + new_password + "&confirm_password=" + confirm_password + "&do=" + do1, true);
        xhttp.send();
