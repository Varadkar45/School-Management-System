...
function updateRecord(recordID) {
    ...
    xhttp.open("GET", "./queries/get_classroom.php?id=" + id, true);
    xhttp.send();
...
function updateRecord1() {
    ...
    if (name !== "" && student_count !== "") {
        ...
        xhttp.open("GET", "./queries/update_classroom.php?id=" + id + "&name=" + name + "&student_count=" + student_count + "&do=" + do1, true);
        xhttp.send();
