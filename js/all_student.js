...
function studentDetails(recordID) {
    ...
    xhttp.open("GET", "./queries/get_student.php?id=" + id, true);
    xhttp.send();
...
$('#btnYes').click(function() {
    ...
    xhttp.open("GET", "./queries/delete_record2.php?id=" + std_id  + "&do=" + do1, true);
    xhttp.send();
});
...
function editStudentSubject(editSubject){
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            xhttp1.open("GET","./queries/get_student_subject.php?id=" + student_id, true);
            xhttp1.send();
...
function editStudentSubject1(){
    ...
    xhttp.open("GET", "./queries/update_student_subject.php?student_id=" + student_id + "&sr_id=" + myJSON + "&do=" + do1, true);
    xhttp.send();
...
$('#btnYes1').click(function() {
    ...
    xhttp.open("GET", "./queries/delete_record1.php?id=" + id  + "&do=" + do1, true);
    xhttp.send();
});
...
function addStudentSubject(){
    ...
    xhttp.open("GET", "./queries/add_student_subject.php?student_id=" + student_id + "&grade_id=" + grade_id + "&sr_id=" + myJSON + "&do=" + do1, true);
    xhttp.send();
...
function addPayment1(){
    ...
    xhttp.open("GET", "./queries/add_student_first_payment.php?student_id=" + student_id + "&admission_fee=" + admission_fee + "&monthly_fee=" + monthly_fee + "&do=" + do1, true);
    xhttp.send();
...
function addPayment3(){
    ...
    xhttp.open("GET", "./queries/add_student_payment.php?student_id=" + student_id + "&monthly_fee=" + monthly_fee  + "&do=" + do1, true);
    xhttp.send();
