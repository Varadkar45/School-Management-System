...
function updateRecord(recordID) {
    ...
    xhttp.open("GET", "./queries/get_subject_routing.php?id=" + id, true);
    xhttp.send();
...
function updateRecord1() {
    ...
    if (fee == '') {
        ...
        xhttp.open("GET", "./queries/update_subject_routing.php?id=" + id + "&grade_id=" + grade + "&subject_id=" + subject + "&teacher_id=" + teacher + "&fee=" + fee + "&do=" + do1, true);
        xhttp.send();
...
$('#btnYes').click(function() {
    ...
    xhttp.open("GET", "./queries/delete_record.php?id=" + id + "&table_name=" + table_name + "&do=" + do1, true);
    xhttp.send();
});
