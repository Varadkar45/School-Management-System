...
function updateRecord(recordID) {
    ...
    xhttp.open("GET", "./queries/get_grade.php?id=" + id, true);
    xhttp.send();
...
function updateRecord1() {
    ...
    if (name !== "" && admission_fee !== "" && institute_fee !== "")  {
        ...
        xhttp.open("GET", "./queries/update_grade.php?id=" + id + "&name=" + name + "&admission_fee=" + admission_fee + "&institute_fee=" + institute_fee + "&do=" + do1, true);
        xhttp.send();
