function teacherDetails(recordID) {
    ...
    xhttp.open("GET", "./queries/get_teacher.php?id=" + id, true);
    xhttp.send();
...
function addSalary1(){
    ...
    xhttp.open("GET", "./queries/add_teacher_salary.php?teacher_id=" + teacher_id + "&monthly_salary=" + monthly_salary  + "&do=" + do1, true);
    xhttp.send();
